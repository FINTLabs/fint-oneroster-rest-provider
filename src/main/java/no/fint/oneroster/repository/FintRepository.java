...
public class FintRepository {
    ...
    public void update() {
        Flux.concat(fintClient.getEducationResources(SkoleResources.class, FintEndpoint.SCHOOL.getKey()),
                        ...
                        fintClient.getEducationResources(KlasseResources.class, FintEndpoint.KLASSE.getKey()),
                        fintClient.getEducationResources(KlassemedlemskapResources.class, FintEndpoint.KLASSEMEDLEMSKAP.getKey()),
